...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Laporan Rekap Kasbon</h1>
</div>
<hr>
<div class="card-header py-3" align="right">
<a href="{{route('laporanrekapkasbon.create')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
