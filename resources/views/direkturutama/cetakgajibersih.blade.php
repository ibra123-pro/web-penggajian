...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Laporan Gaji Bersih</div>
                <div class="card-body"> 
                    <form action="{{route('cetakgaji.index')}}" method="PUT" target="_blank"> 
                    @csrf
                    <fieldset>
                        <div class="form-group row"> 
                            <div class="col-md-4">
                                <label for="klasifikasi">Periode Gaji Bersih</label>
                                <input id="jenis" type="hidden" name="jenis" value="gajibersih" class="form-control">
                                <select id="periode" name="periode"class="form-control" required>
                                    <option value="">--Pilih Periode Gaji Bersih--</option>
