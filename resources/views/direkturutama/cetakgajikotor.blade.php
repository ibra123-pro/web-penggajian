...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Laporan Gaji Kotor</div>
                <div class="card-body"> 
                    ...
                    <fieldset>
                        <div class="form-group row"> 
                            <div class="col-md-4">
                                <label for="klasifikasi">Periode Gaji Kotor</label>
                                <input id="jenis" type="hidden" name="jenis" value="gajikotor" class="form-control">
                                <select id="periode" name="periode"class="form-control" required>
                                    <option value="">--Pilih Periode Gaji Kotor--</option>
