...
{{ csrf_field() }}
    ...
    <fieldset>
        <legend>Edit Data Paket</legend>
        <div class="form-group row">
            <div class="col-md-5">
                <label for="addidpaket">ID Paket</label>
                <input type="text" name="addidpaket" id="addidpaket" class="form-control" maxlength="5" value="{{$paket->id_paket}}" readonly>
            </div>
            <div class="col-md-5">
                <label for="addnmpaket">Nama Paket</label>
                    <select name="addnmpaket" id="addnmpaket" class="form-control" required>
                        <option value="">--Pilih Paket--</option>
                        <option value="{{$paket->nm_paket}}">{{$paket->nm_paket}}</option>
        ...
        <div class="form-group row">
            <div class="col-md-5">
                ...
                <input type="number" name="addharga" id="addharga" class="form-control"  value="{{$paket->harga}}" required> 
            </div>
        </div>
        <div class="col-md-10">
