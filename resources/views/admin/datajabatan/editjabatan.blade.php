    ...
    <fieldset>
        ...
        <div class="form-group row">
            <div class="col-md-5">
                ...
                <input type="text" name="addkdjabatan" id="addkdjabatan" class="form-control" maxlength="5" value="{{$jabatan->kd_jabatan}}" readonly>
            </div>
            <div class="col-md-5">
        ...
        <div class="form-group row">
            <div class="col-md-5">
                ...
                <input type="number" name="addbaypem" id="addbaypem" class="form-control" value="{{$jabatan->baypem}}">
            </div>
            <div class="col-md-5">
                <label for="addbaypen">Gaji Pencapaian</label>
                <input type="number" name="addbaypen" id="addbaypen" class="form-control" value="{{$jabatan->baypen}}">
            </div>
        </div>
        <div class="form-group row">
            <div class="col-md-5">
                <label for="addbayseh">Gaji Masuk Sehari</label>
                <input type="number" name="addbayseh" id="addbayseh" class="form-control" value="{{$jabatan->bayseh}}">
            </div>
            <div class="col-md-5">
                <label for="addbayset">Gaji Masuk Setengah Hari</label>
                <input type="number" name="addbayset" id="addbayset" class="form-control" value="{{$jabatan->bayset}}">
            </div>
        </div>
        <div class="form-group row">
            <div class="col-md-5">
                <label for="addgapok">Gaji Pokok</label>
                <input type="number" name="addgapok" id="addgapok" class="form-control"  value="{{$jabatan->gapok}}">
            </div>
        </div>
        <div class="col-md-10">
